 ...
 */
namespace craft\kit\orm;

class Query
{

    /** @var array */
    protected $_action = [false, null];
    ...
    public function sql()
    {
        ...
        if($this->_sort) {
            $sql .= 'ORDER BY ';
            foreach($this->_sort as $field => $sort) {
